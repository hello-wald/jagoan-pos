...
const statusByCode: Record<string, HttpStatus> = {
  ...
  [AppErrorCode.PRODUCT_IMAGE_NOT_FOUND]: HttpStatus.NOT_FOUND,
  [AppErrorCode.SKU_ALREADY_EXISTS]: HttpStatus.CONFLICT,
  [AppErrorCode.PRODUCT_IMAGE_LIMIT_REACHED]: HttpStatus.CONFLICT,
  [AppErrorCode.INVALID_PRODUCT_IMAGE]: HttpStatus.UNPROCESSABLE_ENTITY,
  [AppErrorCode.PRODUCT_IMAGE_NOT_READY]: HttpStatus.CONFLICT,
  [AppErrorCode.STORAGE_ERROR]: HttpStatus.BAD_GATEWAY,
