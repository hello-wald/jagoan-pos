...
import { useCashierTransactions } from "@/hooks/use-cashier-transactions";
  ...
  return (
    <CashierLayout>
      <div className="h-full overflow-y-auto p-6 md:p-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-0.5">
              Daftar seluruh transaksi kasir yang telah Anda proses pada sesi kerja saat ini
            </p>
          </div>
          ...
          <Button
            ...
            onClick={refresh}
            isLoading={isLoading}
            className="border-slate-300 bg-white text-slate-700 hover:bg-slate-50 shadow-2xs"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          <div className="p-5 rounded-2xl bg-white border border-slate-200/90 shadow-card hover:shadow-elevated transition duration-200 flex items-start justify-between">
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-400 font-medium pt-1">
                Akumulasi transaksi pada akun Anda
              </p>
            </div>
          ...
          <div className="p-5 rounded-2xl bg-white border border-emerald-200/80 shadow-card hover:shadow-elevated transition duration-200 flex items-start justify-between">
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-400 font-medium pt-1">
                Total uang kasir yang Anda kumpulkan
              </p>
            </div>
          ...
          <div className="p-5 rounded-2xl bg-white border border-slate-200/90 shadow-card hover:shadow-elevated transition duration-200 flex items-start justify-between">
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-400 font-medium pt-1">
                Rata-rata belanja pelanggan di kasir Anda
              </p>
            </div>
            <div className="w-12 h-12 rounded-2xl bg-slate-100 flex items-center justify-center text-slate-700 shadow-2xs">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 p-4 rounded-2xl bg-white border border-border shadow-xs">
          <div className="flex-1 max-w-md">
            <Input
              placeholder="Cari berdasarkan No. Transaksi atau Nama Produk..."
              value={searchQuery}
        ...
        <DataTable
          ...
          emptyMessage={
            searchQuery
              ...
              : "Belum ada transaksi penjualan yang diproses pada akun kasir Anda."
          }
      ...
      <Modal
        ...
        description="Salinan digital struk transaksi kasir POS"
        maxWidth="md"
      >
        {selectedTransaction && (
            ...
            <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200 font-sans space-y-4">
              ...
              <div className="text-center pb-3 border-b border-dashed border-slate-300 space-y-1">
                ...
                <div className="text-left text-[11px] text-slate-500 font-medium">
                  Kasir PIC: <strong>{selectedTransaction.cashierName}</strong>
                </div>
              </div>
